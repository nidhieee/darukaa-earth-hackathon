      ...
      {projects.length === 0 ? (
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M100 40C77.9086 40 60 57.9086 60 80C60 110 100 160 100 160C100 160 140 110 140 80C140 57.9086 122.091 40 100 40Z"
            ...
            <path
              d="M100 160 L100 190 M70 190 L130 190"
              stroke="var(--color-brand)"
              strokeWidth="3"
              strokeLinecap="round"
            />
            <path
              d="M120 70C125 75 125 85 120 90"
              stroke="var(--color-primary)"
              strokeWidth="2"
              strokeLinecap="round"
            />
            <path
              d="M80 70C75 75 75 85 80 90"
              stroke="var(--color-primary)"
              strokeWidth="2"
              strokeLinecap="round"
            />
          ...
          >
            Create your first project to start mapping sites and tracking
            impact.
          </p>
